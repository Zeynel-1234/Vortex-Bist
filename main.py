...
app = FastAPI(title="Fraktal Kahin", version="2.4.0")
...
# ═══════════════════════════════════════════════════════════════════
# AŞAMA 3.3 — GÜNLÜK SİNYAL ÜRETİCİSİ (YENİ)
# ───────────────────────────────────────────────────────────────────
    ...
    Returns:
      {
        'symbol': str,
        'has_signal': bool,
        'signal_strength': 'GÜÇLÜ AL' | 'BEKLE' | 'YOK',
        'last_signal_bar': int (kaç bar önce),
        'quality': float (DNA kalitesi),
        ...
      }
    """
    chosen = dna.get('chosen') or {}
...
def lab_today_endpoint(
    ...
    Bu en değerli endpoint — günlük tarama bunun üstünde işliyor.
    """
