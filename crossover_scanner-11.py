"""
================================================================================
  Vortex-BIST · Supertrend(50,1) × EMA(20,high) AYLIK Crossover Scanner
  v2.2 — AYLIK + Supertrend(50,1) × EMA(high,20). Mantık korundu, periyot AYLIK.
...
FETCH_PERIOD   = "10y"   # ~120 AYLIK bar → ST(50) Wilder ATR yakınsaması için yeterli
...
def _analyze_one(symbol: str, df: pd.DataFrame):
    ...
    try:
        ...
        if len(idx) < 55:                        # EMA20 + ST50 (AYLIK) için yeterli geçmiş
            return None
